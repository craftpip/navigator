...
export const CONFIG_SCHEMA = [
  { key: "BROWSERS", category: "backend", type: "json", fallback: '[{"name":"chromium","role":[]},{"name":"cloakbrowser","role":["default","search","fetch","screenshot","devtools"],"cdpUrl":"http://cloak-browser:9222"}]', applies: "hot", description: 'JSON array of browser entries. Each entry: {name, role:[], cdpUrl?}. Roles: "default" (everything), "search" (web_search), "fetch" (web_fetch), "screenshot" (web_page_screenshot/ascii/svg), "devtools" (browser_* tools). Chromium is always present (no cdpUrl); an empty role array makes it a fallback/backup only. Add-ons (CloakBrowser, etc.) must provide a cdpUrl (ws:// endpoint or http:// CDP server).' },
